#!/usr/bin/env python3
#
# Project homepage: https://github.com/TheSmashy/O365Whitlist
# Licence: https://github.com/TheSmashy/O365Whitlist/blob/main/LICENSE
# Created by Anudeep, modified by The Smashy
# ================================================================================
import os
import argparse
import sqlite3
...
if db_exists:
    ...
    if whitelist_local:
        print("[i] {} existing whitelists identified".format(
            len(whitelist_local)))
        if os.path.isfile(smashy_whitelist_location) and os.path.getsize(smashy_whitelist_location) > 0:
            print('[i] Existing anudeep-whitelist install identified')
            with open(smashy_whitelist_location, 'r') as fOpen:
    ...
    with open(smashy_whitelist_location, 'w') as fWrite:
